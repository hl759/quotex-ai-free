...
binance_vault = BinanceRuntimeVault()
binance_broker = BinanceBrokerService(binance_vault)
...
futures_bot_service = FuturesBotService(scanner, futures_module, load_capital_state)
