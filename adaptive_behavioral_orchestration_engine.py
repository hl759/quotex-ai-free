    ...
    def evaluate(
        ...
        if behavior_mode == "EXPANSION":
            ...
            if (
                ...
                reasons.append("Orquestração: edge imperfeito mas válido liberado com controle")
            ...
            if (
                ...
                confidence_shift += 1
                aggressiveness = "controlled"
                reasons.append("Orquestração final: sobrevivência liberou atuação controlada")
            elif (
                current_score >= 3.5
                and discernment_quality in ("premium", "bom")
                and anti_pattern_risk not in ("high", "critical")
