class RiskDominanceEngine:
    ...
    def evaluate(self, environment_type, meta_context, transition_data, current_score, current_confidence):
        ...
        if environment_type == "destructive":
            ...
            score_boost -= 0.01
            confidence_shift += 0
            reasons.append("Risk dominance: caos estruturado segue seletivo, mas operável")

        elif environment_type == "complex":
            score_boost -= 0.02
            confidence_shift += 0
            reasons.append("Risk dominance: ambiente complexo reduz um pouco a autoridade do setup")
        ...
        if conflict_type == "destrutivo":
            ...
            score_boost -= 0.02
            reasons.append("Risk dominance: conflito transicional pede cautela leve")
        ...
        if breakout_quality == "armadilha":
            ...
            score_boost -= 0.03
            reasons.append("Risk dominance: breakout duvidoso enfraquece levemente o contexto")
        ...
        if trend_quality == "exausta":
            ...
            score_boost -= 0.03
            reasons.append("Risk dominance: tendência frágil reduz um pouco a convicção")
        ...
        if not veto:
            ...
            elif environment_type in ("complex", "structured_chaos") and projected_score < 2.6:
                downgrade = "CAUTELA"
                reasons.append("Risk dominance final: oportunidade rebaixada para cautela")
