...
EDGE_VALIDATION_MIN_PROB = float(os.getenv("EDGE_VALIDATION_MIN_PROB", "0.54"))
EDGE_RECENT_WINDOW = int(os.getenv("EDGE_RECENT_WINDOW", "20"))
EDGE_RECENT_KILL_WINDOW = int(os.getenv("EDGE_RECENT_KILL_WINDOW", "12"))
EDGE_RECENT_KILL_EXPECTANCY_R = float(os.getenv("EDGE_RECENT_KILL_EXPECTANCY_R", "-0.10"))
EDGE_RECENT_WARN_EXPECTANCY_R = float(os.getenv("EDGE_RECENT_WARN_EXPECTANCY_R", "-0.04"))
