...
EDGE_PROOF_MIN_TRADES = int(os.getenv("EDGE_PROOF_MIN_TRADES", "28"))
...
EDGE_LIVE_MIN_PROB = float(os.getenv("EDGE_LIVE_MIN_PROB", "0.64"))
...
EDGE_RECENT_KILL_WINDOW = int(os.getenv("EDGE_RECENT_KILL_WINDOW", "16"))
EDGE_RECENT_KILL_EXPECTANCY_R = float(os.getenv("EDGE_RECENT_KILL_EXPECTANCY_R", "-0.20"))
EDGE_RECENT_WARN_EXPECTANCY_R = float(os.getenv("EDGE_RECENT_WARN_EXPECTANCY_R", "-0.10"))
...
EDGE_EXPLORATION_STAKE_MULTIPLIER = float(os.getenv("EDGE_EXPLORATION_STAKE_MULTIPLIER", "0.16"))
EDGE_EXPLORATION_MAX_PER_HOUR = int(os.getenv("EDGE_EXPLORATION_MAX_PER_HOUR", "1"))
